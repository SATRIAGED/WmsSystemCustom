...
<form action="" method="post">
              ...
              <div class="row">
                ...
                <div class="col-xs-6">
                  ...
                  <input type="text" class="form-control" value="SR<?php echo $nota;?>" name="nomor" readonly>
                   <input type="hidden" class="form-control" value="<?php echo $nota;?>" name="nota">
                </div>
                 
                <div class="col-xs-6">
                <label>Tanggal</label>
                  <input type="text" class="form-control" id="datepicker2" name="tgl" readonly>
                </div>
                 ...
                 <tr>
                                            ...
                                            <td>
                                                <select class="form-control" name="pengirim" id="pengirim">
                                                   <?php if( isset($id) && $id!='' ){
                                                  echo ' <option value="'.$w['pengirim'].'" selected>'.$w['pengirim'].'</option>';
                                                    } ?>
                                                    <option value="">--Pilih--</option>
						                                        <option value="Operation">OPS</option>
...
<?php
    ...
    if(isset($_POST["surat"])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql2 = "insert into surat values( '$nota','$nomor','$tgl','$pilih','$tujuan','$telp','$alamat','$pengirim','$nohp','$nopol','$by','')";
