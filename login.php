...
?>
<head>
    <link rel="icon" href="https://appl.ged.co.id/app_citi/dist/upload/Logo.png" type="image/png">
<style>
.responsive {
  width: 20%;
  max-width: 150px;
...
<body class="hold-transition login-page">
  ...
  <center><font color="black"><h1><br> <b><?php echo $footer;?></b></h1></font></center>
  <br>
  <center><img src="dist/upload/logoged.png" class="responsive"></center>
...
?>
    ...
    <div class="container">
  <div id="loginbox" style="margin-top:2px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
  ...
  <!-- <div class="login-logo">
    <a href=""><font color="black"><b><?php echo $nama;?></b><br><b>PT. GED Lintas Indonesia</b></a></font>
  </div> -->
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <!-- /.social-auth-links -->
  <br>
    <p class="login-box-msg">PT. GED Lintas Indonesia.</p>
