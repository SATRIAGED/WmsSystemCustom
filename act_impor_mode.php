...
if(isset($_POST['import'])){ // Jika user mengklik tombol Import
	...
	foreach ($worksheet->getRowIterator() as $row) {
		...
		if($numrow > 1){
			...
			// Buat query Insert
			$query = "INSERT INTO barang VALUES('".$kode."','".$sku."','".$nama."','".$hbeli."','".$hjual."','".$keterangan."','".$kategori."','".$satuan."','".$terjual."','".$terbeli."','".$sisa."','".$stokmin."','".$barcode."','".$brand."','".$rak."','".$exp."','".$warna."','".$ukuran."','".$p."','".$l."','".$t."','".$avatar."','".$no."')";
