      ...
      <div class="box">
       ...
       <div style="padding: 0 15px;">
            ...
            <form method="post" action="" enctype="multipart/form-data">
                <a href="tmp/format_upload_produk_harga.csv" class="btn btn-default">
            ...
            if(isset($_POST['preview'])){
                ...
                if($ext == "csv"){
                    ...
                    echo "<form method='post' action='act_impor_mode.php'>";
                              ...
                              $rak = $get[13]; // Ambil data NIS
                                $exp = $get[14]; // Ambil data NIS
                                  $warna = $get[15]; // Ambil data NIS
                                    ...
                                    $p = $get[17]; // Ambil data NIS
                                    $l = $get[18]; // Ambil data NIS
                                      $t = $get[19]; // Ambil data NIS
                            $keterangan = $get[20]; // Ambil data jenis kelamin
                            $avatar = "dist/upload/index.jpg"; // Ambil data jenis kelamin
                            

                            // Cek jika semua data tidak diisi
                            if($sku == "" && $nama == "" && $hbeli == "" && $hjual == "" && $satuan == "" && $kategori == "" && $sisa == "" && $no == "" && $barcode == "" && $stokmin == "" && $avatar == "")
                           ...
                           $hbeli_td = ( ! empty($hbeli))? "" : " style='background: #E07171;'"; // Jika Alamat kosong, beri warna merah
                            ...
                            $brand_td = ( ! empty($brand))? "" : " style='background: #E07171;'"; // Jika Alamat kosong, beri warna merah
                             $warna_td = ( ! empty($warna))? "" : " style='background: #E07171;'"; // Jika Alamat kosong, beri warna merah
                              ...
                              $p_td = ( ! empty($p))? "" : " style='background: #E07171;'"; // Jika Alamat kosong, beri warna 
                              $l_td = ( ! empty($l))? "" : " style='background: #E07171;'"; // Jika Alamat kosong, beri warna 
                              $t_td = ( ! empty($t))? "" : " style='background: #E07171;'"; // Jika Alamat kosong, beri warna 
                            ...
                            if($sku == "" or $nama == "" or $hbeli == "" or $hjual == "" or $no == "" or $sisa == "" or $avatar == ""){
  ...
  <div class="box">
        ...
        <div class="box-body">
          ...
          <p>3.Foto produk akan diisikan gambar standar, anda bisa menggantinya setelah melakukan upload</p><br>
            ...
            <a href="tmp/contoh_harga.csv" class="btn btn-default">
                    <span class="glyphicon glyphicon-download"></span>
                    Download Contoh CSV
                </a>
        </div>
