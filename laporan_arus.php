            ...
            ?>
                ...
                <section class="col-lg-12 connectedSortable">
                  ...
                  <div class="box" id="tabel1">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body table-responsive" style="max-height: 360px;">
                      <table class="table table-bordered">
                        <thead style="top:0;position:sticky; background-color:#e7e9ed">
                          <tr style="background-color:#e7e9ed">
                            ...
                            <th style="width: 10%">Stok Aktual</th>
                            <th style="width: 10%">Dimensi</th>
                            <th style="width: 10%">CBM In</th>
                            <th style="width: 10%">CBM Out</th>
                            <th style="width: 10%">CBM Aktual</th>
                          </tr>
                        </thead>
                    ...
                    <form method="get" action="">
                      ...
                      <div class="col-sm-3">
                        <div class="row">
                          ...
                          <a onclick="window.location.href='configuration/config_export?forward=laporan_in_out&search=&dari=<?php echo $dr; ?>&sampai=<?php echo $sam; ?>'" class="btn btn-success btn-flat" name="cetak" value="export excel"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Excel</a>
                        </div>
                      </div>
                    </form>
